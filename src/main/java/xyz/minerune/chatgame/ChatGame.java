...
public class ChatGame extends PluginBase {
    ...
    public void flash() {
        ...
        for (Player player : this.getServer().getOnlinePlayers().values()) {
            player.sendMessage(Format.SECONDARY.clean(" Первым отправьте строку %0 в чат и получите %1$", result, String.valueOf(reward)));
        }
    }
    ...
    public void decode() {
        ...
        for (Player player : this.getServer().getOnlinePlayers().values()) {
            player.sendMessage(Format.SECONDARY.clean(" Первым составьте слово из заданных букв %0 и получите %1$", shuffled, String.valueOf(reward)));
        }
    }
    ...
    public void math() {
        ...
        for (Player player : this.getServer().getOnlinePlayers().values()) {
            player.sendMessage(Format.SECONDARY.clean(" Первым решите пример %0 и получите %1$", example, String.valueOf(reward)));
        }
    }
    ...
    public void hangman() {
        ...
        for (Player player : this.getServer().getOnlinePlayers().values()) {
            ...
            player.sendMessage(Format.SECONDARY.clean(" Первым расшифруйте слово %0 и получите %1$", changed, String.valueOf(reward)));
        }
    }
